 ...
 * @subpackage System
 */
class Tx_StaticpubPageexport_System_PageExportTest extends Tx_StaticpubPageexport_Tests_AbstractTestcase {
	/**
	 * @var tx_crawler_lib
	 */
	private $crawlerObj;
	...
	protected function setUp() {
		$this->loadClass( 'Tx_StaticpubPageexport_System_PageExport' );
		$this->loadClass( 'Tx_StaticpubPageexport_Domain_Model_File' );
		$this->loadClass( 'Tx_StaticpubPageexport_Domain_Repository_FileRepository' );
	...
	public function exportPage() {
		...
		$file1['relativePath'] = '';
		$file1['originalPath'] = $this->getPathSite().$publishDir.$staticpubPath.$file1['relativePath']; // result will be: /srv/www/congstar/phpuc/htdocs/typo3temp/staticpub/page_111/
		$file2 = array();
		$file2['name'] = 'test.jpg';
		$file2['relativePath'] = 'images/';
		$file2['originalPath'] = $this->getPathSite().$publishDirForResources.$file2['relativePath'];    // result will be:/srv/www/congstar/phpuc/htdocs/typo3temp/staticpub_resources/images/
