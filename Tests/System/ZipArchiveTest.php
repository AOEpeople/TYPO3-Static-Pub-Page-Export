 ...
 * @subpackage System
 */
class Tx_StaticpubPageexport_System_ZipArchiveTest extends Tx_StaticpubPageexport_Tests_AbstractTestcase {
	/**
	...
	protected function setUp() {
		...
		$this->loadClass( 'Tx_StaticpubPageexport_System_ZipArchive' );
